(ns vibeflow.midi.core
  "Implementation of MIDI related logic that is independent of a particular
  implementation. Deals with interpreting and creating midi message as byte
  arrays (signed) or long arrays (unsigned).
